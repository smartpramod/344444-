...
function preload(){
  polygon_img=loadImage("sprites/superbheem.png");
  blocka1_img=loadImage("sprites/kirmada.png");
  blocka2_img=loadImage("sprites/kirmada.png");
  blocka3_img=loadImage("sprites/kirmada.png");
  blocka4_img=loadImage("sprites/kirmada.png");
  blocka5_img=loadImage("sprites/kirmada.png");
  blocka6_img=loadImage("sprites/kirmada.png");
  blocka7_img=loadImage("sprites/kirmada.png");
  blocka8_img=loadImage("sprites/kirmada.png");
  blocka9_img=loadImage("sprites/kirmada.png");
  blocka10_img=loadImage("sprites/kirmada.png");
  blocka11_img=loadImage("sprites/kirmada.png");
  blocka12_img=loadImage("sprites/kirmada.png");
  blocka13_img=loadImage("sprites/kirmada.png");
  blocka14_img=loadImage("sprites/kirmada.png");
  blocka15_img=loadImage("sprites/kirmada.png");
  blocka16_img=loadImage("sprites/kirmada.png");
...
function draw() {
  ...
  textSize(15);
  text("Press Space to get another chance :)",600,300);
